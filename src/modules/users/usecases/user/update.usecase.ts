...
export class UpdateUserUseCase {
 ...
 constructor(private userRepository: UserRepository, private hashService: HashService, private errors: UserErrors) {}
 ...
 async execute(userDto: UpdateUserDTO) {
  ...
  if (userDto.password) user.password = await this.hashService.hash(userDto.password);
